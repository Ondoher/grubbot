Package('GbAdmin.Services', {
	Bootstrap : new Class({
		...
		onReady : function()
		{
			return SYMPHONY.application.register(GB_ADMIN.appId, this.importServices.unique(), this.exportServices.unique())
				.then(function(response)
				{
					this.userId = response.userReferenceId;

					GB_ADMIN.events.fire('start');
				}.bind(this))
				.done();
		},
	})
...
new GbAdmin.Services.Bootstrap();
