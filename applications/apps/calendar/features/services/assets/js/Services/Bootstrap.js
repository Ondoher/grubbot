Package('Calendar.Services', {
	Bootstrap : new Class({
		...
		onReady : function()
		{
			return SYMPHONY.application.connect(CALENDAR.appId, this.importServices, this.exportServices)
...
new Calendar.Services.Bootstrap();
